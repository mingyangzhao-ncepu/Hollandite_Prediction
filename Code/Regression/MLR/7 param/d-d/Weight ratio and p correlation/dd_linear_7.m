...
fprintf('===== 3: dd = sqrt(6)*(rO+rB) + w1*deltaA + w2*deltaB + w3*ZA + w4*ZB + w5*ENA + w6*ENB + w7*Occ =====\n');
...
T = table(deltaA, deltaB, ZA, ZB, ENA, ENB, Occ, dd_values, ...
    'VariableNames', {'deltaA', 'deltaB', 'ZA', 'ZB', 'ENA', 'ENB', 'Occ', 'dd'});
