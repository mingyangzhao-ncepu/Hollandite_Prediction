...
fprintf('===== 1: a = 5.13*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ZA + w6*(ZA^2) + w7*ZB + w8*(ZB^2) + w9*ENA + w10*(ENA^2) + w11*(deltaA*deltaB) + w12*(deltaA*ZA) + w13*(deltaA*ZB) + w14*(deltaA*ENA) + w15*(deltaB*ZA) +  w16*(deltaB*ZB) + w17*(deltaB*ENA) + w18*(ZA*ZB) + w19*(ZA*ENA) + w20*(ZB*ENA) =====\n');
