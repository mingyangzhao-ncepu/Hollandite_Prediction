...
fprintf('===== 1: a = 5.13*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ZB + w6*(ZB^2) + w7*ENA + w8*(ENA^2) + w9*Occ + w10*(Occ^2) + w11*(deltaA*deltaB) + w12*(deltaA*ZB) + w13*(deltaA*ENA) + w14*(deltaA*Occ) + w15*(deltaB*ZB) +  w16*(deltaB*ENA) + w17*(deltaB*Occ) + w18*(ZB*ENA) + w19*(ZB*Occ) + w20*(ENA*Occ) =====\n');
