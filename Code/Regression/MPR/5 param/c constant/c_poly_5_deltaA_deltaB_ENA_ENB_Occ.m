...
fprintf('===== 2: c = sqrt(2)*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ENA + w6*(ENA^2) + w7*ENB + w8*(ENB^2) + w9*Occ + w10*(Occ^2) + w11*(deltaA*deltaB) + w12*(deltaA*ENA) + w13*(deltaA*ENB) + w14*(deltaA*Occ) + w15*(deltaB*ENA) +  w16*(deltaB*ENB) + w17*(deltaB*Occ) + w18*(ENA*ENB) + w19*(ENA*Occ) + w20*(ENB*Occ) =====\n');
