...
fprintf('===== c = sqrt(2)*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ZA + w6*(ZA^2) + w7*ENA + w8*(ENA^2) + w9*ENB + w10*(ENB^2) + w11*(deltaA*deltaB) + w12*(deltaA*ZA) + w13*(deltaA*ENA) + w14*(deltaA*ENB) + w15*(deltaB*ZA) +  w16*(deltaB*ENA) + w17*(deltaB*ENB) + w18*(ZA*ENA) + w19*(ZA*ENB) + w20*(ENA*ENB) =====\n');
