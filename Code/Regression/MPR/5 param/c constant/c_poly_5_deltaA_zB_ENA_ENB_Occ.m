...
fprintf('===== 2: c = sqrt(2)*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*ZB + w4*(ZB^2) + w5*ENA + w6*(ENA^2) + w7*ENB + w8*(ENB^2) + w9*Occ + w10*(Occ^2) + w11*(deltaA*ZB) + w12*(deltaA*ENA) + w13*(deltaA*ENB) + w14*(deltaA*Occ) + w15*(ZB*ENA) +  w16*(ZB*ENB) + w17*(ZB*Occ) + w18*(ENA*ENB) + w19*(ENA*Occ) + w20*(ENB*Occ) =====\n');
