...
fprintf('===== 3: dd = sqrt(6)*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*ZA + w4*(ZA^2) + w5*ENA + w6*(ENA^2) + w7*ENB + w8*(ENB^2) + w9*Occ + w10*(Occ^2) + w11*(deltaA*ZA) + w12*(deltaA*ENA) + w13*(deltaA*ENB) + w14*(deltaA*Occ) + w15*(ZA*ENA) +  w16*(ZA*ENB) + w17*(ZA*Occ) + w18*(ENA*ENB) + w19*(ENA*Occ) + w20*(ENB*Occ) =====\n');
