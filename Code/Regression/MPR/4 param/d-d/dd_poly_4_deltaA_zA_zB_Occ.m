...
fprintf('===== 3: dd = sqrt(6)*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*ZA + w4*(ZA^2) + w5*ZB + w6*(ZB^2) + w7*Occ + w8*(Occ^2) + w9*(deltaA*ZA) + w10*(deltaA*ZB) + w11*(deltaA*Occ) + w12*(ZA*ZB) + w13*(ZA*Occ) + w14*(ZB*Occ) =====\n');
