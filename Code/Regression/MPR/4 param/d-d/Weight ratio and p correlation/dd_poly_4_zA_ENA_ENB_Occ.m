...
fprintf('===== 3: dd = sqrt(6)*(rO+rB) + w1*ZA + w2*(ZA^2) + w3*ENA + w4*(ENA^2) + w5*ENB + w6*(ENB^2) + w7*Occ + w8*(Occ^2) + w9*(ZA*ENA) + w10*(ZA*ENB) + w11*(ZA*Occ) + w12*(ENA*ENB) + w13*(ENA*Occ) + w14*(ENB*Occ) =====\n');
...
features_matrix = [ZA, ZA.^2, ENA, ENA.^2, ENB, ENB.^2, Occ, Occ.^2, ...
    ZA .* ENA, ZA .* ENB, ZA .* Occ, ...
...
figure;
h = heatmap(correlation_matrix, 'XDisplayLabels', {'Z_{A}', 'Z_{A}^2', 'EN_{A}', 'EN_{A}^2', 'EN_{B}', 'EN_{B}^2', 'Occ', 'Occ^2', 'Z_{A}*EN_{A}', 'Z_{A}*EN_{B}', 'Z_{A}*Occ', 'EN_{A}*EN_{B}', 'EN_{A}*Occ', 'EN_{B}*Occ'}, 'YDisplayLabels', {'Z_{A}', 'Z_{A}^2', 'EN_{A}', 'EN_{A}^2', 'EN_{B}', 'EN_{B}^2', 'Occ', 'Occ^2', 'Z_{A}*EN_{A}', 'Z_{A}*EN_{B}', 'Z_{A}*Occ', 'EN_{A}*EN_{B}', 'EN_{A}*Occ', 'EN_{B}*Occ'});
