...
fprintf('===== 3: dd = sqrt(6)*(rO+rB) + w1*ZB + w2*(ZB^2) + w3*ENA + w4*(ENA^2) + w5*ENB + w6*(ENB^2) + w7*Occ + w8*(Occ^2) + w9*(ZB*ENA) + w10*(ZB*ENB) + w11*(ZB*Occ) + w12*(ENA*ENB) + w13*(ENA*Occ) + w14*(ENB*Occ) =====\n');
