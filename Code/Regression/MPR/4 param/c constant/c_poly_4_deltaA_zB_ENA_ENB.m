...
fprintf('===== 2: c = sqrt(2)*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*ZB + w4*(ZB^2) + w5*ENA + w6*(ENA^2) + w7*ENB + w8*(ENB^2) + w9*(deltaA*ZB) + w10*(deltaA*ENA) + w11*(deltaA*ENB) + w12*(ZB*ENA) + w13*(ZB*ENB) + w14*(ENA*ENB) =====\n');
