...
fprintf('===== 2: c = sqrt(2)*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ENA + w6*(ENA^2) + w7*ENB + w8*(ENB^2) + w9*(deltaA*deltaB) + w10*(deltaA*ENA) + w11*(deltaA*ENB) + w12*(deltaB*ENA) + w13*(deltaB*ENB) + w14*(ENA*ENB) =====\n');
