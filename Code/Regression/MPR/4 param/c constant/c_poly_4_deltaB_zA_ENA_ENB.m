...
fprintf('===== 2: c = sqrt(2)*(rO+rB) + w1*deltaB + w2*(deltaB^2) + w3*ZA + w4*(ZA^2) + w5*ENA + w6*(ENA^2) + w7*ENB + w8*(ENB^2) + w9*(deltaB*ZA) + w10*(deltaB*ENA) + w11*(deltaB*ENB) + w12*(ZA*ENA) + w13*(ZA*ENB) + w14*(ENA*ENB) =====\n');
