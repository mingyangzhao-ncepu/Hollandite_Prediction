...
fprintf('===== 1: a = 5.13*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ZA + w6*(ZA^2) + w7*ZB + w8*(ZB^2) + w9*(deltaA*deltaB) + w10*(deltaA*ZA) + w11*(deltaA*ZB) + w12*(deltaB*ZA) + w13*(deltaB*ZB) + w14*(ZA*ZB) =====\n');
