...
fprintf('===== 1: a = 5.13*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ZB + w6*(ZB^2) + w7*ENB + w8*(ENB^2) + w9*(deltaA*deltaB) + w10*(deltaA*ZB) + w11*(deltaA*ENB) + w12*(deltaB*ZB) + w13*(deltaB*ENB) + w14*(ZB*ENB) =====\n');
