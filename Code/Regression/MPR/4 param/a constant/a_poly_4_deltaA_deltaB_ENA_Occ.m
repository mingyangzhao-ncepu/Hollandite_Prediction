...
fprintf('===== 1: a = 5.13*(rO+rB) + w1*deltaA + w2*(deltaA^2) + w3*deltaB + w4*(deltaB^2) + w5*ENA + w6*(ENA^2) + w7*Occ + w8*(Occ^2) + w9*(deltaA*deltaB) + w10*(deltaA*ENA) + w11*(deltaA*Occ) + w12*(deltaB*ENA) + w13*(deltaB*Occ) + w14*(ENA*Occ) =====\n');
